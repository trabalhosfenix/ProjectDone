...
export function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const sections: NavigationSections = useMemo(() => ({
    global: [
      { id: "projetos", label: "Projetos", icon: FolderOpen, href: "/dashboard?tab=projetos", permissionKey: "projetos" },
      { id: "kanban", label: "Quadro Ágil", icon: Trello, href: "/dashboard?tab=kanban", permissionKey: "kanban" },
      { id: "canvas", label: "PM Canvas", icon: Layout, href: "/dashboard?tab=canvas", permissionKey: "canvas" },
      { id: "resources", label: "Alocação", icon: Users, href: "/dashboard?tab=resources", permissionKey: "resources" },
      { id: "perfis", label: "Perfis", icon: Shield, href: "/dashboard?tab=perfis", permissionKey: "perfis" },
      { id: "calendars", label: "Calendários", icon: Calendar, href: "/dashboard/sistema/calendarios", permissionKey: "settings" },
      { id: "portfolio", label: "Portfólio", icon: LayoutGrid, href: "/dashboard?tab=portfolio", permissionKey: "portfolio" },
      { id: "library", label: "Documentos", icon: FolderOpen, href: "/dashboard?tab=library", permissionKey: "library" },
      { id: "data", label: "Base de Dados", icon: Database, href: "/dashboard?tab=data", permissionKey: "data" },
      { id: "settings", label: "Configurações", icon: Settings, href: "/dashboard?tab=settings", permissionKey: "settings" },
    ],
    project: projectId
      ? [
